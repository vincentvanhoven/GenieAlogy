    ...
    <div class="w-full h-full grid grid-cols-4">
        <div class="relative w-full h-full col-span-3">
            ...
            <div
                ...
                class="absolute right-3 top-2 flex gap-2 rounded shadow p-2 bg-white border border-gray-200"
            >
                <button
                    @click="editor.addPerson"
                    type="button"
                    class="
                        rounded border border-gray-500 p-0.5 cursor-pointer
                ...
                <button
                    ...
                    "
                >
                    <img src="../assets/images/trash.svg" class="w-4 h-4 p-0.5">
                </button>
            </div>
